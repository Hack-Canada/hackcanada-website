...
export default function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  ...
  return (
    <div
      className={`fixed inset-0 bg-[#111031] md:hidden z-50 flex flex-col items-center justify-center transition-transform duration-500 ${
    ...
    >
      ...
      >
        ...
        <nav className="flex flex-col gap-4 p-4 text-center text-xl text-white">
          ...
          <a href="#venue" onClick={onClose}>
            Venue
          </a>
          <a href="#sponsors" onClick={onClose}>
            Sponsors
          </a>
